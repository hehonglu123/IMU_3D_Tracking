        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                if (sensorType == Sensor.TYPE_ACCELEROMETER){
                    Log.d("ACC", sensorEvent.values[0] + " "+ sensorEvent.values[1] + " " + sensorEvent.values[2]);
                }
                else if (sensorType == Sensor.TYPE_GYROSCOPE) {
                    Log.d("GYRO", sensorEvent.values[0] + " "+ sensorEvent.values[1] + " " + sensorEvent.values[2]);
                }
                else if (sensorType == Sensor.TYPE_MAGNETIC_FIELD) {
                    Log.d("MAG", sensorEvent.values[0] + " "+ sensorEvent.values[1] + " " + sensorEvent.values[2]);
                }
