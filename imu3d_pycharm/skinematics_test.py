...
def skin_dead_reckon(df, old_data, type):
    ...
    plt.plot(np.linspace(0, 1, len(wX_interp)), wX_interp, c='r')
    plt.plot(np.linspace(0, 1, len(wX_interp)), wY_interp, c='g')
    plt.plot(np.linspace(0, 1, len(wX_interp)), wZ_interp, c='b')
    plt.show()
